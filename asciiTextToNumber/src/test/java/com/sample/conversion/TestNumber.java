...
public class TestNumber {
	...
	public void testCreate() {
		...
		short numBase = 16;
		int expectedValueforAofBase16 = 41;
		int expectedValueforBofBase16 = 42;
		int expectedValueforCofBase16 = 43;
	...
	public void testToStringShort() {
		...
		String asciiText = "ABC";
		Queue<Integer> valuesOfAciiTextToBase16 = new LinkedList<Integer>();
		...
		int expectedValueforAofBase8 = 101;
		int expectedValueforBofBase8 = 102;
		int expectedValueforCofBase8 = 103;
		...
		valuesOfAciiTextToBase16.add(102);//base 8 value of ascii text B
		valuesOfAciiTextToBase16.add(103);//base 8 value of ascii text C
